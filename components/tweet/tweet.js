...
export default function Tweet(props) {
  const { showCommentIcon = true, padding = "1rem" } = props;
  const { owner, postImage, createdDate, postText, likes, comments, _id } =
    props.tweet;
  ...
  return (
    <div className={style.tweet} style={{ padding: padding }}>
